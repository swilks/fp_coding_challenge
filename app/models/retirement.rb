class Retirement < ActiveRecord::Base
	...
	#Check that current_amount, anual_contributions and desired_anual_income are divisible by 10000
	...
	private 
		#Before the Retirement is created, calculate retirement age and to the model
